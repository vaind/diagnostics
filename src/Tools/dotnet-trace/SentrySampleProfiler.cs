...
namespace Microsoft.Diagnostics.Tools.Trace {
    ...
    internal class SentrySampleProfiler {
        ...
        private Dictionary<double, StackSourceFrameIndex> _nodeNameInternTable;
        ...
        public SentrySampleProfiler(TraceLog traceLog) {
            ...
            var outputStackSource = new MutableTraceEventStackSource(_eventLog) {
                OnlyManagedCodeStacks = true // EventPipe currently only has managed code stacks.
            };
            _outputStackSource = outputStackSource;
            _sample = new StackSourceSample(outputStackSource);
            _nodeNameInternTable = new Dictionary<double, StackSourceFrameIndex>(10);
            _ExternalFrameIndex = outputStackSource.Interner.FrameIntern("UNMANAGED_CODE_TIME");
            _cpuFrameIndex = outputStackSource.Interner.FrameIntern("CPU_TIME");
            ...
            if (UseTasks) {
                _activityComputer = new Tracing.ActivityComputer(_eventSource, _symbolReader);
            ...
            var eventPipeTraceEventPraser = new SampleProfilerTraceEventParser(_eventSource);
